...
def flatgrad(optimizer, loss, var_list, clip_norm=10):
    """
...
def initialize():
    ...
    var = get_session().run(tf.variables_initializer(new_variables))
