...
def parse_args():
    ...
    parser.add_argument("--save-dir", type=str, default="/home/qxy/maddpg/policy/model_navigation.ckpt", help="directory in which training state and model should be saved")
    ...
    parser.add_argument("--benchmark-dir", type=str, default="/home/qxy/maddpg/trainResult/", help="directory where benchmark data is saved")
    parser.add_argument("--plots-dir", type=str, default="/home/qxy/maddpg/trainResult/", help="directory where plot data is saved")
    ...
    with U.single_threaded_session():
        ...
        while True:
            ...
            if len(episode_rewards) > arglist.num_episodes:
                rew_file_name = arglist.plots_dir + arglist.exp_name + '_rewards_formation_navigation.pkl'
                with open(rew_file_name, 'wb') as fp:
                    pickle.dump(final_ep_rewards, fp)
                agrew_file_name = arglist.plots_dir + arglist.exp_name + '_agrewards_formation_navigation.pkl'
                with open(agrew_file_name, 'wb') as fp:
                    pickle.dump(final_ep_ag_rewards, fp)
                step_file_name = arglist.plots_dir + arglist.exp_name + '_steps_formation_navigation.pkl'
                with open(step_file_name, 'wb') as fp:
                    pickle.dump(final_ep_steps, fp)
                crash_file_name = arglist.plots_dir + arglist.exp_name + '_crashes_formation_navigation.pkl'
                with open(crash_file_name, 'wb') as fp:
                    pickle.dump(final_ep_crash, fp)
                done_file_name = arglist.plots_dir + arglist.exp_name + '_done_formation_navigation.pkl'
